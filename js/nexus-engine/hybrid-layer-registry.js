 ...
 *   DOM paint for hybrid: #c-bc (z0) → #c (z3) → #nx-proc-particles (z3, above #c) → #nx-particula-stack (z3) → #nx-wgpu (z4).
...
(function () {
  ...
  var ORDERED_LAYERS = [
    ...
    { id: 'procParticles', domId: 'nx-proc-particles', role: 'CPU + screen-blend mist; MIX Three.js particles live on #nx-particula-host' },
