...
(function () {
  ...
  sequences.drop = [
    { t: 0,   scene: 14, speed: 1, react: 3, warp: 2, palette: 4, morph: 3.5, quality: 'ultra' },
  ...
  sequences.festival = [
    ...
    { t: 3,   beat: 0.8 },
    { t: 4,   explode: true },
    { t: 5,   scene: 15, beat: 1.0 },
    { t: 7,   explode: true, scene: 17 },
    { t: 9,   scene: 4, beat: 1.2 },
    { t: 10,  explode: true },
    { t: 11,  scene: 11, palette: 1 },
  ...
  sequences.genres = [
    ...
    { t: 2.5, scene: 17, beat: 1.2 },
    { t: 4,   scene: 11, explode: true },
    { t: 5.5, scene: 6, beat: 1.0 },
    /* Hip-hop section */
    { t: 7,   scene: 13, palette: 3, speed: 4, react: 7 },
    { t: 8.5, scene: 8, beat: 0.9 },
    { t: 10,  scene: 2, explode: true },
    { t: 11.5, scene: 15, beat: 1.1 },
    /* Rock section */
    { t: 13,  scene: 9, palette: 1, speed: 8, react: 10, warp: 8 },
    { t: 14.5, scene: 0, explode: true },
    { t: 16,  scene: 4, beat: 1.4 },
    { t: 17.5, scene: 17, explode: true },
    { t: 19,  autoMorph: true }
  ];

  /* ---- 4. AI VISUALS (auto-director showcase) ---------------------- */
  sequences.ai = [
    { t: 0,   scene: 14, speed: 3, react: 6, warp: 4, palette: 4, morph: 2.0, quality: 'ultra' },
  ...
  sequences.resolume = [
    ...
    { t: 7,   scene: 11, palette: 3, explode: true },
    { t: 9,   scene: 15, palette: 0 },
    { t: 10,  speed: 8, react: 10, warp: 8, explode: true },
    { t: 11,  scene: 17, beat: 1.3 },
    { t: 12,  speed: 3, react: 5, warp: 4 },
    /* enter present mode for clean output */
    { t: 14,  present: true },
    { t: 15,  scene: 13, explode: true },
